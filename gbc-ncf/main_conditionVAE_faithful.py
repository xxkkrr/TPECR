...
sys.stdout = Logger(f"conditionvae9-faithful-result-{date_str}-num-{test_num}-topk-{topk}-att-{tag_sample_num}-attscore-onetag-pos-{test_pos}-user-{user_mode}-all.txt")
